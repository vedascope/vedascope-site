...
class AstroCalculation(Base):
    ...
    input_json: Mapped[dict[str, Any]] = mapped_column(JSONBType, nullable=False)
    settings_json: Mapped[dict[str, Any] | None] = mapped_column(JSONBType, nullable=True)
    result_json: Mapped[dict[str, Any] | None] = mapped_column(JSONBType, nullable=True)
